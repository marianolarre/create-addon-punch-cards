...
public class CreatePunchCardsPonderScenes {

    /**
     * Storyboard for the createpunchcards_ponder.nbt schematic: a 5x5 andesite base plate (layer 0)
    ...
    public static void examplePonder(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        // (ponder.createpunchcards.createpunchcards_ponder.*), so keep it matching the storyboard id.
        scene.title("createpunchcards_ponder", "Welcome to the Example Addon");
        ...
        // schematic-local, matching the coordinates baked into createpunchcards_ponder.nbt.
        ...
        scene.overlay().showText(70)
                .text("Every block here is loaded from createpunchcards_ponder.nbt")
                .independent(10);
        scene.idle(80);
