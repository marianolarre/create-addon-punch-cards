 ...
 */
public class CreatePunchCardsShaftRenderer<T extends KineticBlockEntity> extends KineticBlockEntityRenderer<T> {

    public CreatePunchCardsShaftRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
