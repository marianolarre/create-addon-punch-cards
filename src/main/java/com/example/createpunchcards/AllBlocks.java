...
import com.example.createpunchcards.content.kinetics.CreatePunchCardsGeneratorBlock;
...
public class AllBlocks {
     ...
     */
    public static final BlockEntry<CreatePunchCardsKineticBlock> EXAMPLE_KINETIC_BLOCK = CreatePunchCards.REGISTRATE
            .block("createpunchcards_kinetic_block", CreatePunchCardsKineticBlock::new)
     ...
     * registered in CreatePunchCards. The transform call attaches the EXAMPLE_SOURCE display
     * source to this block.
     */
    public static final BlockEntry<CreatePunchCardsGeneratorBlock> EXAMPLE_GENERATOR_BLOCK = CreatePunchCards.REGISTRATE
            .block("createpunchcards_generator_block", CreatePunchCardsGeneratorBlock::new)
     ...
     * axis so the shaft rendered by CreatePunchCardsShaftRenderer visibly pokes out of both ends.
