...
@Mod(CreatePunchCards.ID)
public class CreatePunchCards {
    public static final String ID = "createpunchcards";
    ...
    public CreatePunchCards(IEventBus modBus) {
    ...
    private void onClientSetup(FMLClientSetupEvent event) {
        ...
        event.enqueueWork(() -> {
            ...
            PonderIndex.addPlugin(new CreatePunchCardsPonderPlugin());
        });
    }

    /**
     * Feeds the hand-authored language partials (assets/createpunchcards/lang/default/*.json)
    ...
    private void registerLangPartials() {
        REGISTRATE.addDataGenerator(ProviderType.LANG, provider ->
                CreatePunchCardsLangMerger.mergeInto(provider::add));
    }
